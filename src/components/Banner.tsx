...
const Header: React.FC<HeaderProps> = ({}) => {
  return (
    <div 
      id="header"
      className="slide-in-section right transform transition translate-x-0 ease-in-out duration-500 flex justify-center md:justify-between  h-[94vh] items-center flex-wrap">
