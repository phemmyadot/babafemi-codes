...
const Header: React.FC<HeaderProps> = ({}) => {
  return (
    <div 
      id="header"
      className="slide-in-section transform transition translate-x-0 ease-in-out duration-500 flex-col sm:flex-row flex justify-center md:justify-between  h-[90vh] items-center flex-wrap">
